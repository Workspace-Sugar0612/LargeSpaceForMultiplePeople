...
[AddComponentMenu("")]
public class QZAdditiveLevelsNetworkManager : NetworkManager
{
    public static new QZAdditiveLevelsNetworkManager singleton { get; private set; }
